...
{
    public class ODDBViewSelectView : ListView
    {
        public event Action<IODDBView> OnViewSelected; 
        public ODDBViewSelectView()
        {
            style.flexGrow = 1;
            style.flexShrink = 1;
            ...
            this.bindItem = (element, index) =>
            {
                ...
                var item = itemsSource[index] as IODDBView;
        ...
        public void SetDataSource<TView>(IEnumerable<TView> source) where TView : class ,IODDBView
        {
        ...
        public void SetSelectedView(IODDBView currentView)
        {
            ...
            var items = itemsSource as IODDBView[];
