...
Google Sheets integration uses Google Sheets API v4 with Google OAuth user authorization. Apps Script deployment and service-account spreadsheet sharing are not required.
