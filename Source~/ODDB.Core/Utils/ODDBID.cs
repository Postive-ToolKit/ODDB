...
namespace TeamODD.ODDB.Runtime.Utils.Converters
{
    ...
    public class ODDBID : IEquatable<ODDBID>
    {
        ...
        /// <summary>
        /// Clears the in-memory uniqueness tracker. Invoked on Unity domain reload from
        /// Unity.Runtime's DomainReloadHub via the registered TrackedIdCache adapter.
        /// </summary>
        public static void ClearTrackedIds()
        {
